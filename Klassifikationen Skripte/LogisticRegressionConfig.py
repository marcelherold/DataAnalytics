###Logistic Regression Ökonomische Konfiguration
# Import der Module
import pandas as pd
import numpy as np
...
print(df)
df.to_csv("./TabelleOekonomischeKonfig/LogisticRegressionConfig.csv", ";",  index= False)
...
plt.plot(fpr, tpr, marker='.', color='green', label='Logistic Regression')
